...
parser = argparse.ArgumentParser(description="PresToeBiped")
...
# Pre-defined configs
##
from PresToeBiped import PRESTOEBIPED_CFG  # isort:skip
...
class TableTopSceneCfg(InteractiveSceneCfg):
    ...
    # articulation
    robot = PRESTOEBIPED_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
