...
# add path to the DHKimTests/RobotRL directory
# sys.path.append(os.path.dirname(os.path.abspath(__file__)))
# sys.path.append("/home/daros/Repositories/IsaacLab-dhkim/")  # noqa: E402
# add path IsaacLab-dhkim directory
